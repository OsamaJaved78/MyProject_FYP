...
<div className="container">
		<div className='row'>
			<div className="col-md-12 col-sm-12 text-center">
				...
				<h2 className="subheading">WE ARE THE TEAM OF BOOKKARAOO</h2>
			</div>
			<div className="col-lg-4 col-md-4 col-sm-4 wow fadeInUp" data-wow-delay="0.6s">
				<i className="fa fa-cloud"></i>
					<h3 id="about-h3">Planning</h3>
					<p id="about-par">Our board is composed of highly qualified leader's in technology. Each Board Member has proven experience, skills and current expertise aligned to our business goal.</p>
			</div>
